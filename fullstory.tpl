<div class="full-story-body">
        ...
        <div class="about-anime">
            ...
            <div class="description-short-box">
                ...
                <h3>[xfvalue_kodik_plot][xfnotgiven_kodik_plot]
                    [xfgiven_shikimori_plot][xfvalue_shikimori_plot][/xfgiven_shikimori_plot] [/xfnotgiven_kodik_plot]
                </h3>
                        ...
                        <td>
                            ...
                            <span class="badge"><a><svg width="9px" height="9px" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <defs>
                                            ...
                                            <linearGradient id="gradient" x1="-0.82" y1="0.82" x2="55.29" y2="56.94"
        ...
        <div class="watch-pannel">
            ...
            <div class="dropdown-watch-online">
                ...
                <div id="myDropdown" class="dropdown-content-watch-online">
                    ...
                    <button>Отложено</button>
                    <button>Брошено</button>
                    <button>Запланировано</button>
    ...
    <div class="rooms-invite" data-news_id="{news-id}" data-news_title="{title}"
        ...
        <div>
            ...
            <div class="room-invite__desc">Смотри это и любое другое аниме вместе с друзьями<span>, с помощью функции
