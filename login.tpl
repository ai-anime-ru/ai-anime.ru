<div class="login-box" id="login_box" title="Авторизация">
    <div class="title-text-login">
        ...
        <div class="title-text-login-reg">
             <p class="log-register-title">Нет аккаунта?</p><a href="/?do=register" class="log-register">Зарегистрироваться</a>
        </div>
    </div>

    [vk]
    <div class="lb-soc">
        <div>Войти через:</div>[/vk] [google]
        <a class="with-social-login" href="{google_url}">
            <div class="icon">
