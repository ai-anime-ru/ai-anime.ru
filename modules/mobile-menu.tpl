...
// Анимация
const animationDuration = 300; // Время анимации в мс

filterButton.addEventListener('click', () => {
  sidebar.classList.add('animating');
  menuWrapper.classList.add('animating');
  filterContentBox.classList.add('animating');

  setTimeout(() => {
    sidebar.classList.remove('animating');
    menuWrapper.classList.remove('animating');
    filterContentBox.classList.remove('animating');
  }, animationDuration);
});
</script>