                        ...
                        <div>
                            ...
                            <div class="description">
                                [xfgiven_kodik_last_episode]<span class="badge">Серий:
										[xfvalue_shikimori_episodes_aired][xfnotgiven_shikimori_episodes_aired][xfvalue_kodik_last_episode][/xfnotgiven_shikimori_episodes_aired]</span>[/xfgiven_kodik_last_episode] [xfnotgiven_kodik_last_episode]
                ...
                <div class="news-block-hidden">
                    <div class="news-block">
                        ...
                        <div class="description-short-box">
                            ...
                            <h3>
                                [xfvalue_kodik_plot] [xfnotgiven_kodik_plot] [xfvalue_shikimori_plot] [xfnotgiven_shikimori_plot] [/xfnotgiven_shikimori_plot] [/xfnotgiven_kodik_plot]
                            </h3>
                            <a href="{full-link}" title="Подробнее">
                                <span>Подробнее</span>
                            </a>
                        </div>
                    </div>
