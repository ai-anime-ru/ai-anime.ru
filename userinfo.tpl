		...
		<div class="box_in">
			<div class="tab-content">
				<div class="tab-pane active" id="user1">
					<div class="usinf">
						<tr>
							<tb class="ui-c1 grey">Имя
					</div>
					<tb class="ui-c2">{fullname}[not-fullname]Неизвестно[/not-fullname]
				</div>
				</tb>
				<tr>
					<tb class="ui-c1 grey">Место жительства
			</div>
			<tb class="ui-c2">{land}[not-land]Неизвестно[/not-land]
		</div>
		</tr>
		<div>
			...
			<li>
				...
				<div class="ui-c2">[online]<span style="color: #70bb39;">Онлайн</span>[/online][offline]Офлайн[/offline]
				</div>
			</li>
			</ul>
			<ul class="usinf">
